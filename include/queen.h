...
/**
 * @brief Tries to extract a syntactically correct queen move from the string and stores it into the pointer.
...
*/
bool parse_queen_move(struct move* move, const char* str, enum player moving_player, struct board_state* state);
